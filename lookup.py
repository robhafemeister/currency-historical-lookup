...
date_obj = datetime.datetime(int(cyear),int(cmonth),int(cday))
COUNTRY = 'USD'
...
print(f"The currency exchange rate for {convert_currency} on {convert_date_str} was {rate} - {round(rate, 2)}")
